...
module operand_queues_stage import ara_pkg::*; import rvv_pkg::*; import cf_math_pkg::idx_width; #(
    ...
    //forward
    input  elen_t              [NrOperandQueues-1:0] forward_operand_i,
    input  logic               [NrOperandQueues-1:0] forward_operand_valid_i,
  ...
  operand_queue #(
    ...
    .forward_operand_i            (forward_operand_i[AluA]        ),
    .forward_operand_valid_i      (forward_operand_valid_i[AluA]  ),
  ...
  operand_queue #(
    ...
    .forward_operand_i            (forward_operand_i[AluB]        ),
    .forward_operand_valid_i      (forward_operand_valid_i[AluB]  ),
  ...
  operand_queue #(
    ...
    .forward_operand_i            (forward_operand_i[MulFPUA]        ),
    .forward_operand_valid_i      (forward_operand_valid_i[MulFPUA]  ),
  ...
  operand_queue #(
    ...
    .forward_operand_i            (forward_operand_i[MulFPUB]        ),
    .forward_operand_valid_i      (forward_operand_valid_i[MulFPUB]  ),
  ...
  operand_queue #(
    ...
    .forward_operand_i            (forward_operand_i[MulFPUC]        ),
    .forward_operand_valid_i      (forward_operand_valid_i[MulFPUC]  ),
  ...
  operand_queue #(
    ...
    .forward_operand_i            (forward_operand_i[StA]        ),
    .forward_operand_valid_i      (forward_operand_valid_i[StA]  ),
  ...
  operand_queue #(
    ...
    .forward_operand_i            (forward_operand_i[SlideAddrGenA]        ),
    .forward_operand_valid_i      (forward_operand_valid_i[SlideAddrGenA]  ),
  ...
  operand_queue #(
    ...
    .forward_operand_i            (forward_operand_i[MaskB]        ),
    .forward_operand_valid_i      (forward_operand_valid_i[MaskB]  ),
  ...
  operand_queue #(
    ...
    .forward_operand_i            (forward_operand_i[MaskM]        ),
    .forward_operand_valid_i      (forward_operand_valid_i[MaskM]  ),
