...
| lead 倍率 `prefetch_mul`（来自 HDV_HINT `prefetch_mode`） | 1X/2X/4X/8X → L=2^mul=1/2/4/8 | `addrgen.sv` |
...
|---|---|---|---|---|---|---|---|
| **m1** | 32 | 8  | 64  | 1X–8X ✓ | 1X–8X ✓ | 1X/2X/4X ✓·8X⚠ | 1X/2X ✓·4X⚠ |
| **m2** | 64 | 16 | 128 | 1X–8X ✓ | 1X/2X/4X ✓·8X⚠ | 1X/2X ✓·4X⚠ | 1X ✓·2X⚠ |
| **m4** | 128| 32 | 256 | 1X/2X/4X ✓·8X⚠ | 1X/2X ✓·4X⚠ | 1X ✓·2X⚠ | ⚠ |
...
此档下 1–8 流、1X–8X lead 基本都不溢出（见表）。m2 勉强、m4 仅满 VL=128 可用。
