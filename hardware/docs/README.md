...
| 文档 | 内容 |
|---|---|
| `hdv_scalar_backend_comparison.md` | `hdv_scalar_backend.sv` 与完整 CVA6 的详细对比。复用/删减清单、指令集覆盖、CSR stub、FENCE NOP、ebreak task-end。 |
...
4. `hdv_scalar_backend_comparison.md` — 调标量后端时参考
