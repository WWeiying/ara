#!/usr/bin/env python3
"""Merge a QBS benchmark result with Ara's architectural performance report."""
    ...
    for line in text.splitlines():
        ...
        for item in match.group(1).split():
            if "=" in item:
                ...
                result[key] = value
    if not result:
        raise RuntimeError("run log contains no QBS_REAL_BENCH result")
    return result
...
def main() -> None:
    ...
    fields = [
        ...
        "activation_context",
        "context_generation",
        "timed_cycles_per_output_x1000",
        "descriptor_setup_cycles",
        "descriptor_setup_cycles_valid",
        "compute_cycles",
