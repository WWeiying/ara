...
def main():
    ...
    record = {"scope": "Archived LLC cutter, splitter and read-address logic only",
              "not_tested": ["inter-module wiring", "JTAG IP and live AXI commands",
                             "memory data path", "timing", "write unit"],
              "stages": [], "passed": False}
    try:
        ...
        with zipfile.ZipFile(archive) as bundle:
            ...
            for name in ("i_read_unit.v", "i_ar_splitter.v", "i_aw_splitter.v"):
