...
module qbs_adapter_equivalence_tb;
  import qbs_pkg::*;
  logic clk_i = 0;
  ...
  initial begin
    ...
    $display("QBS adapter equivalence PASS cases=%0d strobe_masks=65536 cycles=%0d simultaneous=%0d duplicates=%0d clear_collisions=%0d idle=%0d",
