#define BENCH_CASE_ID "decode_attn_q_qbs_chain3_crossop"
#define BENCH_K 1536
...
#define QBS_BENCH_CONTEXT_GENERATION 41
#define QBS_BENCH_OPERATIONS 3
#define QBS_BENCH_CROSS_OP_REUSE 1
