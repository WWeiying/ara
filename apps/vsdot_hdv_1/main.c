...
float vsdot(const float *a, const float *b, int avl) {
    ...
    // Ten loop instructions fit one 256-bit and one 128-bit packet exactly.
    // The final add in the first packet crosses into the reduction/update EP.
    "dotp_loop:\n"
    "HDV_HINT 0x2a2, 1, 1, 1, 0\n"
    "vsetvli t0, a2, e32, m1, ta, ma\n"
    "vle32.v v8, (a0)\n"
    "sub a2, a2, t0\n"
    "vle32.v v16, (a1)\n"
