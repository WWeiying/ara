...
void vstencil3(int n, const float *x_center, float *y, float a, float b, float c) {
    ...
    "HDV_HINT 0x02, 0, 0, 1, 0, 0, 0\n"
    "vsetvli t0, a0, e32, m1, ta, ma\n"
    "vle32.v v0, (t3)\n"
    "slli t1, t0, 2\n"

    "HDV_HINT 0x00, 0, 1, 0, 0, 0, 0\n"
    "sub a0, a0, t0\n"
    "vfmul.vf v8, v0, fa0\n"
    "vle32.v v1, (t4)\n"

    // Center/right are adjacent streams and share a cross-packet load EP.
    "HDV_HINT 0x00, 0, 0, 0, 0, 0, 0\n"
    "vle32.v v2, (t5)\n"
    "vfmacc.vf v8, fa1, v1\n"
    "vfmacc.vf v8, fa2, v2\n"

    "HDV_HINT 0x08, 0, 1, 0, 0, 0, 1\n"
    "vse32.v v8, (a2)\n"
    "add t3, t3, t1\n"
    "add t4, t4, t1\n"

    "HDV_HINT 0x02, 0, 0, 0, 1, 0, 1\n"
    "add t5, t5, t1\n"
    "add a2, a2, t1\n"
