...
void spmv_f32_32x32(const float *val, const uint32_t *col_idx,
    ...
    // setup: row count and VL configuration. The ABI argument registers serve
    // directly as the running val/column/output pointers.
    "HDV_HINT 0x00\n"
    "li t0, 1024\n"
    "vsetvli s0, t0, e32, m1, ta, ma\n"
    "nop\n"

    // Two-row unroll. Separate vector/FPR temporaries remove cross-row
    // reduction hazards, and the 28 useful instructions fill four 256-bit
    // packets exactly.
    "row_loop:\n"
    "HDV_HINT 0x002, 1, 0, 1, 0\n"
    "vle32.v v0, (a0)\n"
    "vle32.v v1, (a1)\n"
    "vsll.vi v1, v1, 2\n"
    "vluxei32.v v2, (a2), v1\n"
    ...
    "fmv.w.x ft2, zero\n"
    "vfmv.v.f v20, ft2\n"
    "vfredusum.vs v20, v7, v20\n"

    "HDV_HINT 0x2a0, 1, 0, 0, 1\n"
    "vfmv.f.s ft3, v20\n"
    "fsw ft3, 0(a3)\n"
    "addi a0, a0, 128\n"
    "addi a1, a1, 128\n"
